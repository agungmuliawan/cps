						...
						<div class="card">
							<div class="card-body">
								...
								<a href="<?php echo site_url('admin/C_modul/tambah_data_modul');?>" button type="button"
									class="btn btn-dark mb-3">Tambah Data Modul</button></a>
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="text-center">
										...
										foreach ($daftar_modul as $row) {
											?>
										<tr>
											<td style="text-align: center;"><?php echo $no;?></td>
											<td><?php echo $row->nama_modul?></td>
											<td><?php echo $row->tgl_modul?></td>
											<td><?php echo $row->status?></td>
											<td>
												<a href="<?php echo base_url("assets/modul/$row->file");?>"
													span class="btn btn-success"><span
														class=" glyphicon glyphicon-edit"> download</span></a>
												<a href="<?php echo site_url('admin_area/C_modul/hapus_modul/'.$row->id_modul);?>"
