	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="page-title-area">
				...
				<?php echo form_open_multipart('admin/C_modul/proses_tambah_data_libur'); ?>
				...
				<div class="form-group">
					...
					<div class="form-group">
						<label for="example-text-input" class="col-form-label">Jumlah Libur (I)</label>
						<input class="form-control" name="libur" type="text" placeholder="Input Libur..." required">
					</div>
                    <div class="form-group">
						<label for="example-text-input" class="col-form-label">Tanggal</label>
						<input class="form-control" name="tgl" type="date" required">
					</div>
